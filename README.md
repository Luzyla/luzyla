...
**Software Engineer | AI Native | Co-founder @Mate-Crew**

I focus on identifying and dissolving technical bottlenecks. With a scientific background and an **AI-native** mindset, I don't just write code: I analyze processes to find where the friction is and engineer the right solution to eliminate it. At **Mate-Crew**, our mission is straightforward: **We hack your bottleneck.**

### ⚡ Fun fact

🧪 My favorite experiments now involve AI integration instead of test tubes 🧬, but the scientific curiosity remains 🔬🧠.

### 🛠 Tech Stack & Tools

<img alt="JavaScript" src="https://img.shields.io/badge/javascript-grey?logo=javascript"> <img alt="TypeScript" src="https://img.shields.io/badge/typescript-grey?logo=typescript"> <img alt="React" src="https://img.shields.io/badge/react-grey?logo=react"> <img alt="Next" src="https://img.shields.io/badge/next-grey?logo=nextdotjs"> <img alt="HTML" src="https://img.shields.io/badge/html5-grey?logo=html5"> <img alt="CSS" src="https://img.shields.io/badge/css3-grey?logo=css3"> <img alt="tailwindcss" src="https://img.shields.io/badge/tailwind CSS-grey?logo=tailwindcss"> <img alt="Git" src="https://img.shields.io/badge/git-grey?logo=git"> <img alt="npm" src="https://img.shields.io/badge/npm-grey?logo=npm"> <img alt="Ubuntu" src="https://img.shields.io/badge/ubuntu-grey?logo=ubuntu"> <img alt="Bash" src="https://img.shields.io/badge/bash-grey?logo=gnubash">

### 🧉 What I'm working on

- **Process Diagnosis:** Analyzing development workflows to pinpoint structural bottlenecks before writing a single line of code.
- **Workflow Automation:** Building AI-driven tools and CI/CD pipelines to reclaim time and reduce human error.
- **Mate-Crew:** Co-leading a team dedicated to hacking the technical hurdles that slow down company growth.

### 🗂️ Project Inquiry

**Like this setup?** I can help you build yours. [Drop me a line](mailto:coder@luzyla.dev).
